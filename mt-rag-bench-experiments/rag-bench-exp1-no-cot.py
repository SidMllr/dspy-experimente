...
# =============================================================================
# EXPERIMENT 1 — No Chain-of-Thought  (dspy.Predict instead of dspy.ChainOfThought)
#
# Baseline (rag-bench-dspy.py): dspy.ChainOfThought
#
# Hypothesis: ChainOfThought forces the model to write a reasoning step before
# the answer, which should improve quality. Removing it (dspy.Predict) is
# expected to lower the score — confirming that the reasoning step contributes.
#
# Single variable changed: dspy.Predict  [baseline uses dspy.ChainOfThought]
# Everything else — including history parsing — is identical to the baseline.
# =============================================================================
...
# --- EXPERIMENT 1 CHANGE ---
# dspy.Predict goes directly to the answer field — no reasoning step in the prompt.
rag_module = dspy.Predict(StrictRAGAnswer)
...
async def run_benchmark_async():
    ...
    for index, item in enumerate(tasks):
        ...
        model_reasoning = ""  # No reasoning step in Predict mode
    ...
    output_file = f"qwen_rag_answers_exp1_no_cot_{timestamp}.json"
