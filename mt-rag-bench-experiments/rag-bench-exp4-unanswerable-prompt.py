...
# =============================================================================
# EXPERIMENT 4 — Answerability-aware system prompt
#
# Baseline (exp1): generic "state you cannot answer" instruction
#
# Key finding driving this: 28% of score-1 answers occur on questions where
# the reference explicitly says "I don't know / cannot answer". The model
# hallucinates a confident answer instead of refusing. This experiment adds
# a strong, specific refusal instruction with an exact phrase to output.
#
# Single variable changed: signature docstring + answer OutputField desc
...
async def run_benchmark_async():
    ...
    output_file = f"qwen_rag_answers_exp4_unanswerable_prompt_{timestamp}.json"
